...
- \`.claude/registries/\` - Discovery metadata`;
  ...
  // Create routes.yml (backup if exists)
  const routesYml = `# Filesystem Navigation
# Auto-generated by Agentic Framework CLI
...
`;
  ...
  await backupAndCreateRoutesYml(projectPath, routesYml);
