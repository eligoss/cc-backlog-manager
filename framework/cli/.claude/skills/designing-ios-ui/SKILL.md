...
| Token                    | Value | Use                                    |
| ------------------------ | ----- | -------------------------------------- |
| `.padding(.small)` / 4pt | 4pt   | Tight internal spacing (icon-to-label) |
...
// Or use UIColor dynamic provider in code (iOS 13+):
...
- Announce state changes: `AccessibilityNotification.Announcement("Item deleted").post()`
