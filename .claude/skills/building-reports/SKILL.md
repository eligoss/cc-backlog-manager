...
**Framework Files:**
- [module.json](../../../framework/modules/reporting/module.json) - Reporting module capabilities
- [agents/](../../../framework/modules/reporting/agents/) - Agent prompts and workflows
