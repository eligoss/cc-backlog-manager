...
- [committing-code](../committing-code/SKILL.md) - Git workflow and commit standards
- [verifying-quality](../verifying-quality/SKILL.md) - Quality validation checklist
- [validating-markdown](../validating-markdown/SKILL.md) - Documentation standards

### Module Documentation
- **Coding Module Manifest:** [module.json](../../../framework/modules/coding/module.json)
- **Developer Agent:** [ai-app-developer.md](../../../framework/modules/coding/agents/ai-app-developer.md)
