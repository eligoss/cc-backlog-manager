...
**Example invocation:** "Use building-claude-skills to help me create a skill for validating YAML files"
...
**Example:** `maintaining-framework-governance`, `registry-validator`, `documentation-standards`
...
### Related Skills
- [maintaining-framework-governance](../building-framework/SKILL.md) - Governance rules for skill creation
...
- ✅ This skill: `building-claude-skills` (you are reading it)
- ⏳ Next: `maintaining-framework-governance`
...
**Next Skill to Build:** maintaining-framework-governance (Phase 1A)
