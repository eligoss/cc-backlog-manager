...
Use this skill when:
- **Creating a new agent** - Design from scratch with agent principles
...
> **Skill:** Load `generic-shared-using-mcp-meta` for MCP tool guidance
...
```markdown
## MCP Operations
> **Skill:** `generic-shared-using-mcp-meta`
```
