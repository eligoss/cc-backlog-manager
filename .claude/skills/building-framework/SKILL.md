...
**Note:** This skill handles "Should I?" - building-claude-skills handles "How to?"
...
- Examples: maintaining-framework-governance, syncing-with-jira
...
- [ ] Using building-claude-skills for structure?
...
- This skill answers "Should I?" - building-claude-skills answers "How to?"
...
4. **Separation:** This skill ("Should I?") + building-claude-skills ("How to?") + quality-standards (validation)
...
**Pair with:** building-claude-skills (how to build), quality-standards (validation)
