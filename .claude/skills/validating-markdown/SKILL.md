...
name: formatting-markdown-standards
...
**Example invocation:** "Use formatting-markdown-standards to prepare a story markdown file with proper structure and frontmatter"
